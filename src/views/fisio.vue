    ...
    <div class="info-cards">
      ...
      <div class="info-card">
        ...
        <ul>
          ...
          <li>Biomecánica y Kinesiología</li>
          <li>Métodos y Técnicas de Fisioterapia</li>
          <li>Rehabilitación y Fisioterapia Deportiva</li>
        </ul>
      </div>
...
.cardil:hover .cardil-front,
.cardil:hover .cardil-back {
